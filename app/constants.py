...
APP_NAME = "小树时钟"
APP_VERSION = "1.1.0"  # 主版本号.次版本号.修订号，遵循语义化版本规范
VERSION_TYPE = "Beta"  # Alpha/Beta/Release
BUILD_TIME = "2026-08-30"
BUILD_NUMBER = 2  # 整数递增
...
PLUGINS_DIR = str(_DATA_DIR / "plugins_ext")
LOGS_DIR = str(_DATA_DIR / "logs")
...
# 网络
USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:148.0) Gecko/20100101Firefox/148.0"
